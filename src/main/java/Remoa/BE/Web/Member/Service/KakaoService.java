...
public class KakaoService {
    ...
    public KakaoLoginResponseDto kakaoLogin(String code, String redirectUri) {
        ...
        OAuthToken accessToken = getAccessToken(code, redirectUri);
    ...
    public OAuthToken getAccessToken(String code, String redirectUri) {
        ...
        if (redirectUri.equals("https://d197wa6gufmlpc.cloudfront.net/login/kakao")) {
            log.info("redirect_uri = {}", "https://d197wa6gufmlpc.cloudfront.net/login/kakao");
            params.add("redirect_uri", "https://d197wa6gufmlpc.cloudfront.net/login/kakao");
        } else if (redirectUri.equals("http://localhost:3000/login/kakao")) {
            log.info("redirect_uri = {}", "http://localhost:3000/login/kakao");
